/**
 * @name ProperUploaderProcess
 * @version 0.1.0
 * @license MIT
 * @source https://bruh/moment
 * @updateUrl https://bruh/moment
 * @author A user
 * @description Replaces the "Processing" message in the attachment uploader by a indeterminate progress bar
 */
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".ProperUploaderProcess-Category-category {\n    margin-bottom: 20px;\n}\n\n.ProperUploaderProcess-Category-category-header {\n    display: flex;\n    flex-direction: row;\n    cursor: pointer;\n    margin-bottom: 20px;\n}\n\n.ProperUploaderProcess-Category-category-header-details{\n    flex: 1;\n}\n\n.ProperUploaderProcess-Category-category-header-title {\n    font-size: 1.5em;\n    font-weight: bold;\n}\n\n.ProperUploaderProcess-Category-category-header-icon-wrapper{\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    width: 48px;\n    height: 48px;\n}\n\n.ProperUploaderProcess-Category-category-header-icon{\n    width: 24px;\n    height: 24px;\n    color: var(--interactive-active);\n}\n\n.ProperUploaderProcess-Category-category-header-icon.ProperUploaderProcess-Category-opened{\n    transform: rotate(-90deg);\n}\n\n.ProperUploaderProcess-Category-category-content {\n    margin-left: 14px;\n    padding-left: 20px;\n}", "",{"version":3,"sources":["webpack://./node_modules/.pnpm/ittai@1.0.4/node_modules/ittai/components/Category.css"],"names":[],"mappings":"AAAA;IACI,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,eAAe;IACf,mBAAmB;AACvB;;AAEA;IACI,OAAO;AACX;;AAEA;IACI,gBAAgB;IAChB,iBAAiB;AACrB;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,uBAAuB;IACvB,WAAW;IACX,YAAY;AAChB;;AAEA;IACI,WAAW;IACX,YAAY;IACZ,gCAAgC;AACpC;;AAEA;IACI,yBAAyB;AAC7B;;AAEA;IACI,iBAAiB;IACjB,kBAAkB;AACtB","sourcesContent":[".category {\n    margin-bottom: 20px;\n}\n\n.category-header {\n    display: flex;\n    flex-direction: row;\n    cursor: pointer;\n    margin-bottom: 20px;\n}\n\n.category-header-details{\n    flex: 1;\n}\n\n.category-header-title {\n    font-size: 1.5em;\n    font-weight: bold;\n}\n\n.category-header-icon-wrapper{\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    width: 48px;\n    height: 48px;\n}\n\n.category-header-icon{\n    width: 24px;\n    height: 24px;\n    color: var(--interactive-active);\n}\n\n.category-header-icon.opened{\n    transform: rotate(-90deg);\n}\n\n.category-content {\n    margin-left: 14px;\n    padding-left: 20px;\n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	"category": "ProperUploaderProcess-Category-category",
	"category-header": "ProperUploaderProcess-Category-category-header",
	"category-header-details": "ProperUploaderProcess-Category-category-header-details",
	"category-header-title": "ProperUploaderProcess-Category-category-header-title",
	"category-header-icon-wrapper": "ProperUploaderProcess-Category-category-header-icon-wrapper",
	"category-header-icon": "ProperUploaderProcess-Category-category-header-icon",
	"opened": "ProperUploaderProcess-Category-opened",
	"category-content": "ProperUploaderProcess-Category-category-content"
};
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ ProperUploaderProcess)
});
...
const manifest_namespaceObject = JSON.parse('{"u2":"Proper Uploader Process"}');
...
var options = {"attributes":{"ittai":true,"plugin":"ProperUploaderProcess"}};
...
var ToastWrapper_options = {"attributes":{"ittai":true,"plugin":"ProperUploaderProcess"}};
...
const Progress = find((m)=>{
    var ref;
    return (m === null || m === void 0 ? void 0 : (ref = m.default) === null || ref === void 0 ? void 0 : ref.displayName) === "Progress";
});
class ProperUploaderProcess extends Plugin_Plugin {
    start() {
        before("InfiniteUploaderLook", findByProps("AttachmentUpload"), "AttachmentUpload", ([props])=>{
